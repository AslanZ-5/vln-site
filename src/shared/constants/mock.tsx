...
export const servicesCardsMock: ServicesCardsMockItem[] = [
  {
    ...
    optionInformation: [
      {
        id: 1,
        label: 'Предоставляется дополнительный объем интернет-трафика без ограничения по скорости',
        description: [],
        prise: '5 Гб',
      },
      {
  ...
  },
  {
    ...
    optionInformation: [
      {
        id: 1,
        label: 'В рамках опции ежемесячно предоставляется неограниченный доступ к видеохостингу YouTube.',
        description: [
          {
            apps: '',
            icons: []
      ...
      {
        id: 4,
        label: 'Безлимитный доступ на видеохостинг предоставляется при соблюдении следующих условий:',
        description: [
          {
            apps: '- с момента списание абонентской платы прошло не более 30 дней,',
            icons: []
          },
          {
            apps: '- с момента списания ежесуточной платы опции «Жара» (тариф «Солнце») прошло не более 24 часов.',
            icons: []
          }
        ],
        prise: '',
  ...
  },
  {
    ...
    optionInformation: [
      {
        id: 1,
        label: 'В рамках услуги предоставляется неограниченный по объему трафика доступ в интернет с момента подключения и до 23:59 оплаченных суток.',
        description: [
          {
  ...
  },
  {
    ...
    optionInformation: [
      ...
      {
        id: 4,
        label: 'При подключении услуги в рамках пакета',
        description: [
          {
            apps: '- звонки на номера операторов Республики Крым, г. Севастополь и Краснодарского края не тарифицируется, ежемесячный/ежесуточный пакет минут при звонках по указанным направлениям не расходуется.',
            icons: []
          },
        ],
        prise: '',
      ...
      {
        id: 5,
        label: 'После исчерпания пакета, тарификация идет согласно условиям тарифного плана. ',
        description: [],
        prise: '',
      },
      {
  ...
  },
  {
    ...
    optionInformation: [
      {
        id: 1,
        label: 'Услуга предоставляет возможность осуществлять звонки на номера операторов Республики Крым, г. Севастополя и Краснодарского края без ограничений по количеству.',
        description: [
          {
  ...
  },
  {
    ...
    optionInformation: [
      {
        id: 1,
        label: 'В рамках Опции предоставляется неограниченный по объему трафика доступ в интернет с момента подключения и до 23:59 оплаченных суток.',
        description: [
          {
